...
export class CreateInitialEntities1762477357211 implements MigrationInterface {
    name = 'CreateInitialEntities1762477357211'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_def6dfed9f6ae6ad773d4407f8" ON "contacts" ("company_id", "instagram") WHERE instagram IS NOT NULL`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_0d1355e73099f0b63af1aff43d" ON "contacts" ("company_id", "phone") WHERE phone IS NOT NULL`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_2b6e6a285853ab03c6f7ab4118" ON "contacts" ("company_id", "email") WHERE email IS NOT NULL`);
        await queryRunner.query(`CREATE TABLE "companies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(255) NOT NULL, "description" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_d4bc3e82a314fa9e29f652c2c22" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user_companies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "company_id" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_f41bd3ea569c8c877b9a9063abb" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_2b6e6a285853ab03c6f7ab4118"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0d1355e73099f0b63af1aff43d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_def6dfed9f6ae6ad773d4407f8"`);
